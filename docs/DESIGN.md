...
> Design notes for **media-cron-failure-alert-go** — a runnable go example that Alert on scheduled media streaming job failures with a compact Go client.
...
- **Feature code** — the actual task: scheduled-job-alerting.
